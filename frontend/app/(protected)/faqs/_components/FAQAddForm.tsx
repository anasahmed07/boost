            ...
            <div className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => onUpdate('question', sanitizeInput(e.target.value))}
                ...
                <div>
                    ...
                    <textarea
                        value={newFAQ.answer}
                        onChange={(e) => onUpdate('answer', sanitizeInput(e.target.value))}
                        rows={4}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                        placeholder="Enter the answer (leave empty if not answered yet)..."
                    />
                </div>
